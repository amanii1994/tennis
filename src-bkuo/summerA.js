                ...
                <View style={{ backgroundColor: '#fff', width: '100%', height: '100%' }}>
                    ...
                    <TouchableOpacity style={{ flexDirection: 'row', alignSelf: 'center', justifyContent: 'space-around' }}>
                        <View style={[styles.containerC, { padding: wp('2%') }]}>
                            <Text style={[styles.headerText, { alignSelf: 'center', justifyContent: 'flex-start', flex: 1,fontSize:wp('4%') }]}>PReservation Fees</Text>
                            <Text style={[styles.textP, { justifyContent: 'flex-end',fontSize:wp('4%') }]}>$ 25</Text>
                        </View>
                    </TouchableOpacity>
                   <View style={{alignSelf:'center'}}>
                   <Text style={[styles.textP, {fontSize:wp('4%') }]}>Fully Reforadable</Text>
                   </View>
