        ...
        return (
            <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
                <View style={{ backgroundColor: '#fff',  flex: 1 }}>
                    ...
                    <View style={{ margin:wp('1%') ,backgroundColor: '#fff',}}>
                        <CalendarStrip 
                    ...
                    <View style={[styles.containerCD, { flexDirection: 'row', height: hp('13%'), }]}>
                        ...
                        <TouchableOpacity style={{ flex: 1, justifyContent: 'center', backgroundColor: '#69C53A', height: hp('16%'), width: wp('24'), borderRadius: wp('2%'), borderWidth: wp('0.2'), borderColor: '#000000', height: hp('5%'), marginRight: wp('1%'), marginTop: hp('6%') }}>
