                ...
                <View style={{ backgroundColor: '#fff', width: '100%', height: '100%' }}>
                    ...
                    <View style={{ flexDirection: 'row', margin: wp('4%') }}>
                        ...
                        <View style={styles.containerB}>
                            <Text style={[styles.headerText, { fontFamily:fontReg,color: '#fff', alignSelf: 'center' }]}>Ages 4-8</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <View style={styles.containerC}>
                            <Text style={[styles.headerText, { alignSelf: 'center',fontSize:wp('3.5%') }]}>15 min</Text>
                            <Text style={styles.textP}>$ 8</Text>
                        </View>
                        <View style={styles.containerC}>
                            <Text style={[styles.headerText, { alignSelf: 'center', fontSize:wp('3.5%')}]}>30 min</Text>
                            <Text style={styles.textP}>$ 15</Text>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'row' }}>
                        <View style={styles.containerC}>
                            <Text style={[styles.headerText, { alignSelf: 'center' ,fontSize:wp('3.5%')}]}>45 min</Text>
                            <Text style={styles.textP}>$ 21</Text>
                        </View>
                        <View style={styles.containerC}>
                            <Text style={[styles.headerText, { alignSelf: 'center',fontSize:wp('3.5%') }]}>1 Hour</Text>
                            <Text style={styles.textP}>$ 25</Text>
                        </View>
                    </View>
