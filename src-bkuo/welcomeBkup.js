        ...
        return (
            <View style={{ backgroundColor: '#008ED6', width: '100%', height: '100%',flex:1 }}>
                ...
                <View  style={styles.bottomContainer}>
                    <View style={{alignSelf:'center',marginLeft:wp('8%')}}><Image source={require('./img/smile.png')} /></View>
                    <View style={{flexDirection:'column', alignSelf:'center', marginLeft:wp('6%')}}>
                        ...
                        <Text style={{fontFamily:fontSemiBold}}>Sign in or create an account</Text>
                    </View>
                    </View>
                </TouchableOpacity> 
                </View>
