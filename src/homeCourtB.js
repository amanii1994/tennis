            ...
            <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
                <View style={{ backgroundColor: '#fff', width: '100%', height: '100%', flex: 1 }}>
                    ...
                    <View style={styles.container}>
                        <TouchableOpacity style={{ alignSelf: 'center', marginLeft: wp('3%'), }} onPress={() => this.props.navigation.navigate('home')}><Linericon name="left-arrow-1" size={wp('7.5%')} color='#000000' /></TouchableOpacity>
                    ...
                    <View style={[{ marginLeft: wp('4%'), marginRight: wp('3%'), marginTop:wp('2%'),borderColor:'#D5D5D5',borderWidth:wp('0.4%'),padding:wp('4.5%') }]}>
                        <Text style={styles.textP}>Thank You...the tiny form has been submitted and your little one is days away from the ultimate tennis experience.</Text>
                    </View>
