...
export default class mommymeA extends Component {
    ...
    goNext() {
        if (this.state.quantity && this.state.price) {
            this.props.navigation.navigate('mommymeB', {
                ...
                <View style={{ backgroundColor: '#fff', width: '100%', height: '100%' }}>
                    ...
                    <View style={{ flexDirection: 'row', margin: wp('4%') }}>
                        ...
                        <View style={[styles.containerB, { alignSelf: 'center' }]}>
                            <Text style={[styles.textP, { color: '#fff', alignSelf: 'center', fontFamily: fontSemiBold }]}>Age 2-3 </Text>
                        </View>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', alignSelf: 'center', justifyContent: 'space-around' }}>
                        ...
                        {/* <View style={[styles.containerC, { padding: wp('2%') }]}>
                            <Text style={[styles.textP, {  justifyContent: 'flex-start', flex: 1, }]}>45 min</Text>
                            <Text style={[styles.textP1, { justifyContent: 'flex-end' }]}>$ 25</Text>
                        </View> */}
                    </View>
