                ...
                <View style={{ backgroundColor: '#fff', width: '100%', height: '100%' }}>
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={{ width: wp('100%'), height: hp('23 %'), backgroundcolor: '' }}>
                                <Image source={require('./img/dropin7.png')} style={{ flex: 1, height: undefined, width: undefined, }} resizeMode="cover" />
                        </View>
                    ...
                    <View style={{ flexDirection: 'row', margin: wp('4%') }}>
                        ...
                        <View style={[styles.containerB,{alignSelf:'center'}]}>
                            <Text style={[styles.textP, { color: '#fff', alignSelf: 'center',fontFamily: fontSemiBold }]}>2-3 Year Old</Text>
                        </View>
                    </View>
