...
import { StyleSheet, Text, Alert, AsyncStorage, ScrollView, Platform, View, Image, TextInput, KeyboardAvoidingView, Keyboard, TouchableWithoutFeedback, TouchableOpacity } from 'react-native';
...
export default class login extends Component {
    ...
    handleSubmit = () => {
        ...
        if (formStatus.length > 0) {
            ...
            let res = restapi.post('login', { email: this.state.email, password: this.state.password });
            res.then((res) => {
